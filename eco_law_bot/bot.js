...
const RENDER_URL = process.env.RENDER_EXTERNAL_URL || 'https://eco-talim.onrender.com';
setInterval(() => {
    require('https').get(RENDER_URL + '/api/ping').on('error', (err) => {
